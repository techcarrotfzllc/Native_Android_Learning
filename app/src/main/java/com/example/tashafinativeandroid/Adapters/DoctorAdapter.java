...
public class DoctorAdapter extends ArrayAdapter<RetrofitModal> {

    private static class ViewHolder {
        TextView name;
    }

    public DoctorAdapter(@NonNull Context context, ArrayList<RetrofitModal> retrofitModal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.name.setText(retrofitModal.getDoctorName());
