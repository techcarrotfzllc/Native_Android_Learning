...
public class FacilityAdapter extends ArrayAdapter<RetrofitModal> {

    private static class ViewHolder {
        TextView name;
    }

    public FacilityAdapter(@NonNull Context context, ArrayList<RetrofitModal> retrofitModal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.name.setText(retrofitModal.getClinicName());
